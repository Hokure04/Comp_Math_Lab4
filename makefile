...
lab4: lab4.f90 file_reader.o keyboard_reader.o parameters.o linear_aproximation.o quadratic_aproximation.o
	$(FC) lab4.f90 -o lab4 file_reader.o keyboard_reader.o parameters.o linear_aproximation.o quadratic_aproximation.o
